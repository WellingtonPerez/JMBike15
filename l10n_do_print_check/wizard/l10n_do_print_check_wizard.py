...
class l10n_do_print_check_wizard(models.TransientModel):
    ...
    def default_get(self,vals):
        vals = super(l10n_do_print_check_wizard,self).default_get(vals)
    ...
    def print_cheque(self):
        ...
        return self.env.ref('l10n_do_print_check.action_report_print_cheque').report_action(self.payment_id)
